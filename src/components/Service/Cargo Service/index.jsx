...
const ProjectCargoServicesForm = () => {
    ...
    <div className="container-xxl py-5"> 
      <div className="container py-5">
        <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 className="mb-5">PROJECT CARGO SERVICES</h1>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <button type="button" className="btn btn-secondary mb-3" onClick={addCargo}>+ Add Additional Cargo Details</button>
